...
1. Introduzione
	...
	2. Esposizione del problema
		...
		- Problemi di costo
		- Problemi progetturali
	3. Obiettivi della ricerca
		- Creazione ambiente Hybrid autonomo (Hybrid on demand)
2. Definizioni
	1. Hybrid Cloud
		- Definizione ambiente on Premise
		- Definizione ambiente on Cloud
		- Definizione ambiente Hybrid
	2. Cloud Continuum
	3. Service Mesh
		- Definizione microservizio
		- Definizione protocollo comunicativo attraverso l’uso di Proxy
		- Introduzione a Istio e Gloo-Mesh
3. Architettura
	1. Introduzione dei componenti
	2. Metodo applicativo dei componenti
4. Soluzione
	1. Creazione Cluster On-Premise (Linode)
	2. Creazione Cluster On-Cloud
	3. Installazione componenti Istio
	4. Creazione Load Balancer
	5. Registrazione dei clusters
	6. Creazione Policy di comunicazione
		- Traffic Shift
		- Failure
5. Risultati
	1. Statistiche descrittive
	2. Analisi dei fattori
	3. Confronto con soluzioni esistenti
6. Conclusione
